...
{
    /// <summary>
    /// Version 1 of Siemens S7 wrapper - original implementation
    /// SiemensS7WrapperV1 (Original Implementation)
    /// Uses the standard S7.Net library approach with minimal customization
    /// Standard implementation for string handling
    /// Standard implementation for DateTime
    /// Works well for boolean and string data types
    /// Known issues with Double/Real values, Word writing, and DateTime formats
    /// </summary>
    public class SiemensS7WrapperV1 : ISiemensS7Wrapper
    {
        #region PROPERTIES
        ...
        public SiemensS7WrapperV1(CpuType cpuType, string ipAddress, int rack = 0, int slot = 1)
        {
